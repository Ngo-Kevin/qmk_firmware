...
// custom keycode effects
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    // print the keycode that aren't valid; this is prob a catch all just in case
    ...
    switch (keycode) {
        case ALT_TAB:
            // alt + tab. if tab is pressed within 1 sec then switch
